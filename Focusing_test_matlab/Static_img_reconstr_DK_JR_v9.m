...
lambda = 639e-9; % m // Justin's LED: 633nm //New fibered LED (Chris'): 624nm //max:625nm
...
if FLAG_manual
    ...
    rec_r= Prop_SSA(If{1,1},pixelsize/interp_factor,pixelsize/interp_factor,-z2_list,lambda_V/1000/n_glass);

    figure,imshow(angle(rec_r),[])       
    set(gca, 'XLim', [900,1600], 'YLim', [600,1100])
