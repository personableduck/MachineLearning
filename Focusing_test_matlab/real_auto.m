...
% ttt3=avg_holo(350:750 , 1600:2100);
...
count=count+1;
z1_list(count)=z*10;
%rec_r= Prop_SSA(ttt3,pixelsize/interp_factor,pixelsize/interp_factor,-z1_list(count),lambda_V/1000/n_glass);
...
%rec_r= Prop_SSA(ttt3,pixelsize/interp_factor,pixelsize/interp_factor,-z2_list(count),lambda_V/1000/n_glass);
...
%rec_r= Prop_SSA(ttt3,pixelsize/interp_factor,pixelsize/interp_factor,-z3_list(count),lambda_V/1000/n_glass);
...
% z4_list(count)=370.5;
%rec_r= Prop_SSA(ttt3,pixelsize/interp_factor,pixelsize/interp_factor,-z4_list(count),lambda_V/1000/n_glass);
...
% z4_list(count)=370.5;
%rec_r= Prop_SSA(ttt3,pixelsize/interp_factor,pixelsize/interp_factor,-z5_list(count),lambda_V/1000/n_glass);
...
% z4_list(count)=370.5;
%rec_r= Prop_SSA(ttt3,pixelsize/interp_factor,pixelsize/interp_factor,-z6_list(count),lambda_V/1000/n_glass);
