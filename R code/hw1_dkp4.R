...
plot(degree.distribution(g_fire,mode="in"), col="red")
plot(degree.distribution(g_fire,mode="out"), col="blue")


# Problem 4 (b)
# Calculate Diameter
diam_unconnected_true = diameter(g_fire, unconnected=TRUE)
diam_unconnected_false = diameter(g_fire, unconnected=FALSE)
