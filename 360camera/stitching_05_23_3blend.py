...
img1 = Image.open('C:/Users/1234/Downloads/6_shots/1.jpg')
...
img4= Image.open('C:/Users/1234/Downloads/6_shots/4.jpg')
img4 = img4.crop((0, 0, 1139, 800))

img5= Image.open('C:/Users/1234/Downloads/6_shots/5.jpg')
img5 = img5.crop((0, 0, 1139, 745))
#boundary dicided

img_0 = img0.crop((0, 0, 949, 718))
img_1 = img1.crop((16, 13, 974, 731))
img_2 = img2.crop((16, 13, 1010, 731))
img_3 = img3.crop((16, 26, 1120, 744))
img_4 = img4.crop((16, 82, 950, 800))
img_5 = img5.crop((16, 30, 1139, 748))
...
for index in range(15):
    ...
    img_b44 = img4.crop((951+(index*1), 82, 952+(index*1), 800))
    img_b5  = img5.crop((0+(index*1), 30, 1+(index*1), 748))
    

    out01=Image.blend(img_b0,img_b1, 0.0715*index)
    out12=Image.blend(img_b11,img_b2, 0.0715*index)
    out23=Image.blend(img_b22,img_b3, 0.0715*index)
    out34=Image.blend(img_b33,img_b4, 0.0715*index)
    out45=Image.blend(img_b44,img_b5, 0.0715*index)
...
new_imk.save('05_23_result_num4.png')