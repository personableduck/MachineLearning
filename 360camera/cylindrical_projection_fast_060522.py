...
#	img_mapped5 = cv2.remap(img_5, (map_xy), None, False)
	...
	ret5, filename_5 = cap_5.read()  
      ...
      rcap_0=imutils.rotate(filename_0,angle=-1,center=None,scale=1.0)
      rcap_1=imutils.rotate(filename_1,angle=1,center=None,scale=1.0)
      rcap_2=imutils.rotate(filename_2,angle=-0.5,center=None,scale=1.0)
      rcap_3=imutils.rotate(filename_3,angle=-1,center=None,scale=1.0)
      rcap_4=imutils.rotate(filename_4,angle=0,center=None,scale=1.0)
      rcap_5=imutils.rotate(filename_5,angle=1,center=None,scale=1.0)
