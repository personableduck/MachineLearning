...
filename_0 = cap_0.read()  
filename_1 = cap_1.read()  
filename_2 = cap_2.read()  
filename_3 = cap_3.read()  
filename_4 = cap_4.read()  
filename_5 = cap_5.read()  
#filename = "1_right2.jpg"

file_list=[filename_0,filename_1,filename_2,filename_3,filename_4,filename_5]

imageA_0 = cv2.imread(file_list[0])
imageA_1 = cv2.imread(file_list[1])
imageA_2 = cv2.imread(file_list[2])
imageA_3 = cv2.imread(file_list[3])
imageA_4 = cv2.imread(file_list[4])
imageA_5 = cv2.imread(file_list[5])
...
img_0 = img_mapped0[25:695, 80:1150]
img_1 = img_mapped1[30:700, 122:1150]
img_2 = img_mapped2[25:695, 225:1150]
img_3 = img_mapped3[25:695, 210:1180]
img_4 = img_mapped4[27:697, 100:1120]
img_5 = img_mapped5[38:708, 145:1270]
...
for index in range(10):
    ...
    img_b0 = img_mapped0[25:695, 1151+(index*1):1152+(index*1)]
    img_b1 = img_mapped1[30:700, 111+(index*1):112+(index*1)]
    
    img_b11 = img_mapped1[30:700, 1151+(index*1):1152+(index*1)]
    img_b2  = img_mapped2[25:695, 214+(index*1):215+(index*1)]
    
    img_b22 = img_mapped2[25:695, 1151+(index*1):1152+(index*1)]
    img_b3  = img_mapped3[25:695, 199+(index*1):200+(index*1)]
    
    img_b33 = img_mapped3[25:695, 1181+(index*1):1182+(index*1)]
    img_b4  = img_mapped4[27:697, 89+(index*1):90+(index*1)]
    
    img_b44 = img_mapped4[27:697, 1121+(index*1):1122+(index*1)]
    img_b5  = img_mapped5[38:708, 134+(index*1):135+(index*1)]
