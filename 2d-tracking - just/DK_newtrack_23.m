...
distance_threshold_fast = (150/fps)/pixelsize; %******threshold object tracking. need to control. maximum ditance to distinguish as a same object
%unit is um. // I limited that the fasted sperm's speed is 140 um/sec.
%fps means frame per second

%distance_threshold_skip=4.5;
distance_threshold_skip=(40/fps)/pixelsize; %<----30 before

decide_slow=(50/fps)/pixelsize;
