function ans_xyz= new_search1_first_start_point(xyz_1,xyz,fast_obj_start,new_search1,increase_number,distance_threshold_fast,priority_degree_rate,priority_zero)
count_passe=0;
distance_fast_mat=0;    
[row_f1,col_f1,check_f1]=find( xyz{1,fast_obj_start+increase_number}(:,1) < xyz_1{1,fast_obj_start}(new_search1,1) + distance_threshold_fast & xyz{1,fast_obj_start+increase_number}(:,1) > xyz_1{1,fast_obj_start}(new_search1,1) - distance_threshold_fast);   
