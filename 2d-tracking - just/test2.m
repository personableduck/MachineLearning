...
rest_start_searching= 3;

    %prevent_rest_check={0};
    %angle_information=0;
    fast_obj_start=4*rest_start_searching-3;
    duple_num_count=0;
    size_duple_mat=size(duple_mat);
    if(fast_obj_start == 1)
        end_duple_mat=1;
    else
        end_duple_mat=size_duple_mat(1,1)+1;
    end
    for duple_pre_loop=1:end_duple_mat
        if(duple_pre_loop == 1)
            start_inside=1;
            if(fast_obj_start == 1)
            ...
            start_inside=duple_mat(duple_pre_loop-1,1);
            change_inside_loop=duple_mat(duple_pre_loop-1,1);
            prevent_rest_check{1,duple_mat(duple_pre_loop-1,1)}=0;
            prevent_rest_check{1,duple_mat(duple_pre_loop-1,1)}(1,1)=nan;
            prevent_rest_check{1,duple_mat(duple_pre_loop-1,1)}(1,2)=nan;
        end
        for inside_loop=start_inside:change_inside_loop
            stop_search=0;
            distance_fast_mat=0;        
            if(fast_obj_start == 1)
                                                                                                                ...
                                                                                                                if(increase_check == 0)                                                                               
                                                                                                                    ...
                                                                                                                    if( pass_numfil == 1)
                                                                                                                        ...
                                                                                                                        if(fast_obj_start == 1) 
                                                                                                                            ...
                                                                                                                            distance_six_mat=0;
                                                                                                                            [row_f5,col_f5,check_f5]=find( xyz{1,fast_obj_start+4}(:,1) < xc_5 + distance_threshold_fast/2 & xyz{1,fast_obj_start+4}(:,1) > xc_5 - distance_threshold_fast);       
                                                                                                                            ...
                                                                                                                            if( prevent_rest_check{1,1} == 0)
                                                                                                                                ...
                                                                                                                                if(duplication_number ~= 0)
                                                                                                                                    ...
                                                                                                                                    if( duplehappen == 1)
                                                                                                                                        ...
                                                                                                                                        duple_mat(duple_num_count,1)=duplication_number;
                                                                                                                                        stop_search=1; %prevent duplicate trajectories
                                                                                                                                    end
                                                                                                                                else
                                                                                                                                    prevent_rest_check{1,inside_loop}(1,1) = fast_total_coor{1,inside_loop}(fast_obj_start,1);
