                                                                                                                ...
                                                                                                                if(duplecount ~= 0)
                                                                                                                    ...
                                                                                                                    if( duplehappen == 1)
                                                                                                                        ...
                                                                                                                        for check_duple_loop=1:duplecount
                                                                                                                            ...
                                                                                                                            fst_mv_oj_coor(1,3) = duplication_number(check_duple_loop,1);
                                                                                                                            fst_mv_oj_coor(2,3) = duplication_number(check_duple_loop,1);
                                                                                                                            fst_mv_oj_coor(3,3) = duplication_number(check_duple_loop,1);
