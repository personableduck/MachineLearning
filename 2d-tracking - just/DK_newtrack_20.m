    ...
    for inside_loop=1:change_inside_loop
        ...
        if(fast_obj_start == 1)
            ...
            if( estm_ft_size(1,1) >= fast_obj_start )
                ...
                xc_1=fast_total_coor{1,inside_loop}(fast_obj_start,1);
                yc_1=fast_total_coor{1,inside_loop}(fast_obj_start,2);
                xc_back_1=fast_total_coor{1,inside_loop}(fast_obj_start-1,1);
                yc_back_1=fast_total_coor{1,inside_loop}(fast_obj_start-1,2);
                xc_back_2=fast_total_coor{1,inside_loop}(fast_obj_start-2,1);
                yc_back_2=fast_total_coor{1,inside_loop}(fast_obj_start-2,2);
            end
        end
        if(check_f1 == 1)  
                                                                                                            ...
                                                                                                            if(increase_check == 0)                                                                               
                                                                                                                ...
                                                                                                                if( pass_numfil == 1)
                                                                                                                    ...
                                                                                                                    if(fast_obj_start == 1) 
                                                                                                                        ...
                                                                                                                        if( fast_total_coor{1,1} == 0)
                                                                                                                            ...
                                                                                                                            if(duplication_number ~= 0)                                                                                  
                                                                                                                                ...
                                                                                                                                if( duplehappen == 1)
                                                                                                                                    ...
                                                                                                                                    new_search1=duplication_number;
                                                                                                                                end
                                                                                                                            else
                                                                                                                                fast_total_coor(1,object_number_count)={fst_mv_oj_coor};
                                                                                                                                stop_search=1; %prevent duplicate trajectories
                                                                                                                        ...
                                                                                                                        if( abs(angle_final_th) > tangent_control)
                                                                                                                            angle_information(object_number_count,1)=(abs(abs(atan((fst_mv_oj_coor(2,2)-fast_total_coor{1,inside_loop}(fast_obj_start,2))/(fst_mv_oj_coor(2,1)-fast_total_coor{1,inside_loop}(fast_obj_start,1)))*180/pi)-abs(atan((fst_mv_oj_coor(1,2)-fast_total_coor{1,inside_loop}(fast_obj_start,2))/(fst_mv_oj_coor(1,1)-fast_total_coor{1,inside_loop}(fast_obj_start,1)))*180/pi))+abs(abs(atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(1,1)))*180/pi)-abs(atan((fst_mv_oj_coor(2,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(2,1)-fst_mv_oj_coor(1,1)))*180/pi))+abs(abs(atan((fst_mv_oj_coor(4,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(4,1)-fst_mv_oj_coor(2,1)))*180/pi)-abs(atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(2,1)))*180/pi)))/priority_degree_rate + ( abs(dist_thresh_sec - dist_thresh_third) + abs(dist_thresh_third-dist_rest_th) +abs(dist_rest_th-dist_final_th) );
                                                                                                                        else
                                                                                                                            angle_information(object_number_count,1)=(abs(atan((fst_mv_oj_coor(2,2)-fast_total_coor{1,inside_loop}(fast_obj_start,2))/(fst_mv_oj_coor(2,1)-fast_total_coor{1,inside_loop}(fast_obj_start,1)))*180/pi-atan((fst_mv_oj_coor(1,2)-fast_total_coor{1,inside_loop}(fast_obj_start,2))/(fst_mv_oj_coor(1,1)-fast_total_coor{1,inside_loop}(fast_obj_start,1)))*180/pi)+abs(atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(1,1)))*180/pi-atan((fst_mv_oj_coor(2,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(2,1)-fst_mv_oj_coor(1,1)))*180/pi)+abs(atan((fst_mv_oj_coor(4,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(4,1)-fst_mv_oj_coor(2,1)))*180/pi-atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(2,1)))*180/pi))/priority_degree_rate + ( abs(dist_thresh_sec - dist_thresh_third) + abs(dist_thresh_third-dist_rest_th) +abs(dist_rest_th-dist_final_th) );
                                                                                                                        end
                                                                                                                        distance_six_mat=0;
                                                                                                                        [row_f5,col_f5,check_f5]=find( xyz{1,fast_obj_start+4}(:,1) < xc_5 + distance_threshold_fast & xyz{1,fast_obj_start+4}(:,1) > xc_5 - distance_threshold_fast);       
                                                                                                                        ...
                                                                                                                        if( prevent_rest_check{1,1} == 0)
                                                                                                                            ...
                                                                                                                            if(duplication_number ~= 0)
                                                                                                                                ...
                                                                                                                                if( duplehappen == 1)
                                                                                                                                    ...
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+1,1) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+1,2) = nan;      
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+1,3) = duplication_number;

                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+2,1) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+2,2) = nan;        
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+2,3) = duplication_number;

                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+3,1) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+3,2) = nan;       
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+3,3) = duplication_number;

                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+4,1) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+4,2) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+4,3) = duplication_number; 

                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+5,1) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+5,2) = nan;
                                                                                                                                    fast_total_coor{1,duplication_number}(fast_obj_start+5,3) = duplication_number;
                                                                                                                                    ...
                                                                                                                                    if( estm_ft_size(1,1) >= fast_obj_start )
                                                                                                                                        [row_f1,col_f1,check_f1]=find( xyz{1,fast_obj_start+1}(:,1) < fast_total_coor{1,duple_mat}(fast_obj_start,1) + distance_threshold_fast & xyz{1,fast_obj_start+1}(:,1) > fast_total_coor{1,duple_mat}(fast_obj_start,1) - distance_threshold_fast);
                                                                                                                                        xc_1=fast_total_coor{1,duple_mat}(fast_obj_start,1);
                                                                                                                                        yc_1=fast_total_coor{1,duple_mat}(fast_obj_start,2);
                                                                                                                                        xc_back_1=fast_total_coor{1,duple_mat}(fast_obj_start-1,1);
                                                                                                                                        yc_back_1=fast_total_coor{1,duple_mat}(fast_obj_start-1,2);
                                                                                                                                        xc_back_2=fast_total_coor{1,duple_mat}(fast_obj_start-2,1);
                                                                                                                                        yc_back_2=fast_total_coor{1,duple_mat}(fast_obj_start-2,2);
                                                                                                                                    end
                                                                                                                                    if(check_f1 == 1)  
                                                                                                                                        maxsize_fast2_xyz=size(row_f1); %read size
                                                                                                                                        distance_count1=0;
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    if(posit_nega == posit_nega2)
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if(increase_check == 0)                                                                               
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            if( pass_numfil == 1)
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                if( abs(angle_final_th) > tangent_control)
                                                                                                                                                                                                                                                    angle_information(object_number_count,1)=(abs(abs(atan((fst_mv_oj_coor(2,2)-fast_total_coor{1,duple_mat}(fast_obj_start,2))/(fst_mv_oj_coor(2,1)-fast_total_coor{1,duple_mat}(fast_obj_start,1)))*180/pi)-abs(atan((fst_mv_oj_coor(1,2)-fast_total_coor{1,duple_mat}(fast_obj_start,2))/(fst_mv_oj_coor(1,1)-fast_total_coor{1,duple_mat}(fast_obj_start,1)))*180/pi))+abs(abs(atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(1,1)))*180/pi)-abs(atan((fst_mv_oj_coor(2,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(2,1)-fst_mv_oj_coor(1,1)))*180/pi))+abs(abs(atan((fst_mv_oj_coor(4,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(4,1)-fst_mv_oj_coor(2,1)))*180/pi)-abs(atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(2,1)))*180/pi)))/priority_degree_rate + ( abs(dist_thresh_sec - dist_thresh_third) + abs(dist_thresh_third-dist_rest_th) +abs(dist_rest_th-dist_final_th) );
                                                                                                                                                                                                                                                else
                                                                                                                                                                                                                                                    angle_information(object_number_count,1)=(abs(atan((fst_mv_oj_coor(2,2)-fast_total_coor{1,duple_mat}(fast_obj_start,2))/(fst_mv_oj_coor(2,1)-fast_total_coor{1,duple_mat}(fast_obj_start,1)))*180/pi-atan((fst_mv_oj_coor(1,2)-fast_total_coor{1,duple_mat}(fast_obj_start,2))/(fst_mv_oj_coor(1,1)-fast_total_coor{1,duple_mat}(fast_obj_start,1)))*180/pi)+abs(atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(1,1)))*180/pi-atan((fst_mv_oj_coor(2,2)-fst_mv_oj_coor(1,2))/(fst_mv_oj_coor(2,1)-fst_mv_oj_coor(1,1)))*180/pi)+abs(atan((fst_mv_oj_coor(4,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(4,1)-fst_mv_oj_coor(2,1)))*180/pi-atan((fst_mv_oj_coor(3,2)-fst_mv_oj_coor(2,2))/(fst_mv_oj_coor(3,1)-fst_mv_oj_coor(2,1)))*180/pi))/priority_degree_rate + ( abs(dist_thresh_sec - dist_thresh_third) + abs(dist_thresh_third-dist_rest_th) +abs(dist_rest_th-dist_final_th) );
                                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                                distance_six_mat=0;
                                                                                                                                                                                                                                                [row_f5,col_f5,check_f5]=find( xyz{1,fast_obj_start+4}(:,1) < xc_5 + distance_threshold_fast & xyz{1,fast_obj_start+4}(:,1) > xc_5 - distance_threshold_fast);       
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                if( prevent_rest_check{1,1} == 0)
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    prevent_rest_check{1,duple_mat}(1,1) = fast_total_coor{1,duple_mat}(fast_obj_start,1);
                                                                                                                                                                                                                                                    prevent_rest_check{1,duple_mat}(1,2) = fast_total_coor{1,duple_mat}(fast_obj_start,2); 
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+1,1) = fst_mv_oj_coor(1,1);
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+1,2) = fst_mv_oj_coor(1,2);       
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+1,3) = duple_mat;

                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+2,1) = fst_mv_oj_coor(2,1);
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+2,2) = fst_mv_oj_coor(2,2);         
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+2,3) = duple_mat;

                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+3,1) = fst_mv_oj_coor(3,1);
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+3,2) = fst_mv_oj_coor(3,2);       
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+3,3) = duple_mat;

                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+4,1) = fst_mv_oj_coor(4,1);
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+4,2) = fst_mv_oj_coor(4,2);
                                                                                                                                                                                                                                                    fast_total_coor{1,duple_mat}(fast_obj_start+4,3) = duple_mat;  

                                                                                                                                                                                                                                                    if(stop_search2==1)
                                                                                                                                                                                                                                                        fast_total_coor{1,duple_mat}(fast_obj_start+5,1) = fst_mv_oj_coor(5,1);
                                                                                                                                                                                                                                                        fast_total_coor{1,duple_mat}(fast_obj_start+5,2) = fst_mv_oj_coor(5,2);
                                                                                                                                                                                                                                                        fast_total_coor{1,duple_mat}(fast_obj_start+5,3) = duple_mat;
