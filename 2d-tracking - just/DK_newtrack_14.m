...
for rest_start_searching= 1:max_frame_size
                                                                                                                ...
                                                                                                                if( pass_numfil == 1)
                                                                                                                    ...
                                                                                                                    if(fast_obj_start == 1) 
                                                                                                                        ...
                                                                                                                        if( prevent_rest_check{1,1} == 0)
                                                                                                                            prevent_rest_check(1,inside_loop)={fst_mv_oj_coor};
                                                                                                                            stop_search=1; %prevent duplicate trajectories
                                                                                                                        else
                                                                                                                            %------prevent duplication--------
                                                                                                                            ...
                                                                                                                            if(duplecount ~= 0)
                                                                                                                                ...
                                                                                                                                if( duplehappen == 1)
                                                                                                                                    ...
                                                                                                                                    for check_duple_loop=1:duplecount
                                                                                                                                        ...
                                                                                                                                        prevent_rest_check(1,duplication_number(check_duple_loop,1)) = {fst_mv_oj_coor};
                                                                                                                                    end
                                                                                                                                end
                                                                                                                            else
                                                                                                                                prevent_rest_check(1,inside_loop) = {fst_mv_oj_coor};          
    ...
    for inside_loop=1:change_inside_loop
        if( fast_obj_start > 1)
            fast_total_coor{1,inside_loop} = [fast_total_coor{1,inside_loop}; prevent_rest_check{1,inside_loop}];
        end
    end
end
