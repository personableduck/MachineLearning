function [fast_total_coor,stop_search,prevent_rest_check]=prevent_last2(origin_size_fst,fst_mv_oj_coor,fast_total_coor,prevent_rest_check,duple_mat,ans_xyz5,jump_number,stop_search)
...
if( prevent_rest_check{1,1} == 0)
    ...
    prevent_rest_check{1,duple_mat}(5,3) = fst_mv_oj_coor(4,3);
    ...
    fast_total_coor{1,duple_mat}(origin_size_fst+4,1) = fst_mv_oj_coor(4,1);
    fast_total_coor{1,duple_mat}(origin_size_fst+4,2) = fst_mv_oj_coor(4,2);
    fast_total_coor{1,duple_mat}(origin_size_fst+4,3) = duple_mat;  
    fast_total_coor{1,duple_mat}(origin_size_fst+4,4) = jump_number;

    if(~isnan(ans_xyz5))
        fast_total_coor{1,duple_mat}(origin_size_fst+5,1) = fst_mv_oj_coor(5,1);
        fast_total_coor{1,duple_mat}(origin_size_fst+5,2) = fst_mv_oj_coor(5,2);
        fast_total_coor{1,duple_mat}(origin_size_fst+5,3) = duple_mat;
        fast_total_coor{1,duple_mat}(origin_size_fst+5,4) = jump_number;

        prevent_rest_check{1,duple_mat}(6,1)= fst_mv_oj_coor(5,1);           
        prevent_rest_check{1,duple_mat}(6,2)= fst_mv_oj_coor(5,2);
        prevent_rest_check{1,duple_mat}(6,3)= fst_mv_oj_coor(5,3);
    end
