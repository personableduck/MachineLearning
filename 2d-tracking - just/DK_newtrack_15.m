        ...
        if(check_f1 == 1)  
            ...
            if(fast_obj_start == 1) 
                ...
                if( before_distance <= decide_slow)
                    [row_dist,col_dist,check_dist]=find(distance_fast_mat(:,1) <= distance_threshold_fast/2);            
                else
                                                                                                                ...
                                                                                                                if( pass_numfil == 1)
                                                                                                                    ...
                                                                                                                    if(fast_obj_start == 1) 
                                                                                                                        ...
                                                                                                                        if( prevent_rest_check{1,1} == 0)
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+1,1) = prevent_rest_check{1,inside_loop}(2,1);
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+1,2) = prevent_rest_check{1,inside_loop}(2,2);       
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+1,3) = inside_loop;

                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+2,1) = prevent_rest_check{1,inside_loop}(3,1);
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+2,2) = prevent_rest_check{1,inside_loop}(3,2);         
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+2,3) = inside_loop;

                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+3,1) = prevent_rest_check{1,inside_loop}(4,1);
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+3,2) = prevent_rest_check{1,inside_loop}(4,2);       
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+3,3) = inside_loop;

                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+4,1) = prevent_rest_check{1,inside_loop}(5,1);
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+4,2) = prevent_rest_check{1,inside_loop}(5,2);
                                                                                                                            fast_total_coor{1,inside_loop}(fast_obj_start+4,3) = inside_loop;  

                                                                                                                            if(stop_search2==1)
                                                                                                                                fast_total_coor{1,inside_loop}(fast_obj_start+5,1) = prevent_rest_check{1,inside_loop}(6,1);
                                                                                                                                fast_total_coor{1,inside_loop}(fast_obj_start+5,2) = prevent_rest_check{1,inside_loop}(6,2);
...
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(1,1) = prevent_rest_check{1,inside_loop}(1,1);
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(1,2) = prevent_rest_check{1,inside_loop}(1,2);
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(2,1) = prevent_rest_check{1,inside_loop}(2,1);
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(2,2) = prevent_rest_check{1,inside_loop}(2,2);  
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(3,1) = prevent_rest_check{1,inside_loop}(3,1);
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(3,2) = prevent_rest_check{1,inside_loop}(3,2);  
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(4,1) = prevent_rest_check{1,inside_loop}(4,1);
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(4,2) = prevent_rest_check{1,inside_loop}(4,2);  
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(5,1) = prevent_rest_check{1,inside_loop}(5,1);
%                                                                                                                                         prevent_rest_check{1,duplication_number(check_duple_loop,1)}(5,2) = prevent_rest_check{1,inside_loop}(5,2);
%                                                                                                                                         
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+1,1) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(2,1);
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+1,2) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(2,2);       
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+1,3) = fst_mv_oj_coor(1,3);
% 
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+2,1) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(3,1);
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+2,2) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(3,2);         
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+2,3) = fst_mv_oj_coor(2,3);
% 
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+3,1) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(4,1);
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+3,2) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(4,2);       
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+3,3) = fst_mv_oj_coor(3,3);
% 
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+4,1) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(5,1);
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+4,2) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(5,2);
%                                                                                                                                         fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+4,3) = fst_mv_oj_coor(4,3);  
% 
%                                                                                                                                         prevent_rest_check{1,inside_loop}(1,1) = nan;
%                                                                                                                                         prevent_rest_check{1,inside_loop}(1,2) = nan;
% 
%                                                                                                                                         if(stop_search2==1)
%                                                                                                                                             prevent_rest_check{1,duplication_number(check_duple_loop,1)}(6,1)= prevent_rest_check{1,inside_loop}(6,1);
%                                                                                                                                             prevent_rest_check{1,duplication_number(check_duple_loop,1)}(6,2)= prevent_rest_check{1,inside_loop}(6,2);
%                                                                                                                                             
%                                                                                                                                             fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+5,1) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(6,1);
%                                                                                                                                             fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+5,2) = prevent_rest_check{1,duplication_number(check_duple_loop,1)}(6,2);
%                                                                                                                                             fast_total_coor{1,duplication_number(check_duple_loop,1)}(fast_obj_start+5,3) = fst_mv_oj_coor(5,3);
%                                                                                                                                         end
%                                                                                                                                     end
                                                                                                                                end
                                                                                                                            else
